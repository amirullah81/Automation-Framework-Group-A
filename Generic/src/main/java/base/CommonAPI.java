...
/**
 * Created by A S M Amirullah on 4/25/2016.
 */
public class CommonAPI {
    ...
    public void typeByID(String locator, String value){driver.findElement(By.id(locator)).sendKeys(value);}
    ...
    //Verify Data
    public void verifyDataByCss(String locator, String expectedData){
        assertEquals(expectedData, driver.findElement(By.cssSelector(locator)).getText());
    }

    public void verifyDataByXpath(String expectedData, String locator){
        assertEquals(expectedData, driver.findElement(By.xpath(locator)).getText());
    }

    //Select hidden option value by java script
    public List<WebElement> getHiddenOptionValues(String locator, String selectValue) throws InterruptedException{
        WebElement options = driver.findElement(By
                .cssSelector(locator));
        ((JavascriptExecutor) driver)
                .executeScript("$(\""+locator+"\").show()");
      /*((JavascriptExecutor) driver).executeScript(
              "arguments[0].checked = true;", options);*/
        Select selectData = new Select (options);
        List<WebElement> optionValues = selectData.getOptions();
    ...
    public void hideOptionValues(String locator){
        ((JavascriptExecutor) driver)
                .executeScript("$(\""+locator+"\").hide()");
    }
    //if checkBox not selected then select
    public void checkBoxIsSelectByCss(String locator) {
    ...
    public void checkBoxIsUncheckByCss(String locator) {
        WebElement checkBox = driver.findElement(By.cssSelector(locator));
        if (checkBox.isSelected()) {
            checkBox.click();
        }
    ...
    public void selectRadioButton(String locator, String value){
        List<WebElement> radiobuttons = driver.findElements(By.name(locator));
