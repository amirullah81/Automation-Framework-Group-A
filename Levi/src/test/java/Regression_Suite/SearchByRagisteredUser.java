 ...
 */
public class SearchByRagisteredUser extends CommonAPI {
    @Test
    public void searchBoxByRagisteredUser() throws InterruptedException {
        ...
        Thread.sleep(2000);
       // driver.findElement(By.cssSelector("div.email-signup > div.tooltip-wrapper > span.close")).click();
        List<String> textToBeSearch = Arrays.asList( "sharts", "cap","shoes","hat");
